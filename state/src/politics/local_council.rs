...
impl FactionDistribution {
    ...
    pub fn populares_share(&self) -> f64 {
        ...
        if total == 0 {
            ...
            self.populares_count as f64 / total as f64
        }
    }
    ...
    pub fn optimates_share(&self) -> f64 {
        ...
        if total == 0 {
            ...
            self.optimates_count as f64 / total as f64
        }
    }
}
...
pub fn calculate_curial_faction_alignment(
    ...
    let optimates_defecting =
        (council.faction_distribution.optimates_count as f64 * defection_rate) as u32;
    let moderates_defecting =
        (council.faction_distribution.moderates_count as f64 * defection_rate * 0.5) as u32;

    // Transfer seats
    council.faction_distribution.optimates_count = council
        .faction_distribution
        .optimates_count
        .saturating_sub(optimates_defecting);
    council.faction_distribution.moderates_count = council
        .faction_distribution
        .moderates_count
        .saturating_sub(moderates_defecting);
