...
static MIDEAST_MALE: &[&str] = &[
    "Ahmed", "Mohammed", "Ali", "Hassan", "Hussein", "Omar", "Khalid", "Ibrahim", "Yusuf",
    "Abdullah", "Abdul", "Rahman", "Karim", "Tariq", "Salem", "Farid", "Nabil", "Rashid",
    "Mansour", "Jamal", "Faisal", "Bassam", "Ghazi", "Sami", "Wael", "Hadi", "Najib", "Salim",
    "Adel", "Munir", "Sabri", "Latif", "Anwar", "Saad", "Hamid", "Rami", "Bilal", "Ziad", "Fouad",
    "Galal", "Mamdouh", "Nasser", "Sherif", "Tahsin", "Wahid", "Yasin", "Zahir", "Amin", "Fuad",
    "Raouf",
];

static MIDEAST_FEMALE: &[&str] = &[
    "Fatima", "Aisha", "Zainab", "Maryam", "Khadija", "Hala", "Layla", "Nour", "Salma", "Rana",
    "Hana", "Amal", "Dina", "Lina", "Mona", "Nadia", "Rima", "Sara", "Yara", "Farah", "Ghada",
    "Huda", "Intisar", "Jamila", "Karima", "Latifa", "Maha", "Nisreen", "Rasha", "Siham",
    "Taghrid", "Wafa", "Yasmin", "Zahra", "Amira", "Badriya", "Dalia", "Eman", "Fadia", "Hiba",
    "Iman", "Kawthar", "Maysa", "Nabila", "Ruba", "Samar", "Wijdan", "Yara", "Zina", "Amani",
];
...
mod tests {
    ...
    fn test_vip_to_leader_ideology_mapping() {
        ...
        assert!(
            !leader2.main_trait.is_empty(),
            "Leader should have a main trait"
        );
        assert!(
