...
pub fn get_sse_tax_multiplier(
    ...
    let applicable_zone = special_economic_zones
        .iter()
...
pub fn apply_sse_vat_exemption(
    ...
    special_economic_zones.iter().any(|z| {
        z.region_id == company.region_id
...
pub fn process_subvention_conversions(
    ...
    zone.eligible_companies
        .retain(|id| !companies_to_remove.contains(id));
...
pub fn check_zone_eligibility_for_clawback(
    ...
    for subvention in zone.investment_subventions.iter_mut() {
        ...
        let company_still_in_zone = companies
            .iter()
